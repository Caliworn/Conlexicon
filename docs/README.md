...
| [Advanced Filter Query Plan](ADVANCED_FILTER_QUERY_PLAN.md) | 活跃计划 | 高级筛选 F0 清点，以及 EntryFilter 与 feature result session 的后续阶段。 |
...
4. 处理查询窗口、cursor 或筛选时分别补读查询缓存与高级筛选专题文档。
