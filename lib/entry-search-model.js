(function initEntrySearchModel(root, factory) {
  ...
  function entrySearchValueRecords(entry = {}, dictionary = {}, options = {}) {
    ...
    if (fields.has("morphology")) {
      morphologyModel.morphologySearchStrings(entry, dictionary).forEach((value, position) => {
        addRecord("morphology", value, { sourceType: "morphology", sourcePosition: position, valueType: "generated" });
      });
    }
