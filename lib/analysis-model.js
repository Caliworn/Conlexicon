(function initAnalysisModel(root, factory) {
  ...
  function analysisSliceDepsForPage(page = "overview", subpage = "") {
    ...
    return ["relation", "rootFamilies", "coverage", "tags", "forms", "morphology", "search", "activity"];
  }
  ...
  function emptyAnalysisSlices() {
    ...
    return {
      ...
      coverage: {
        ...
        ipaEntryCount: 0,
        morphologyEntryIds: [],
        noDefinitionEntryCount: 0,
        noExampleEntryCount: 0,
        noNoteEntryCount: 0,
        noSourceEntryCount: 0,
        noIpaEntryCount: 0,
